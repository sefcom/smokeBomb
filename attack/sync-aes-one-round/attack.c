...
static inline void flush_te(U32 x, U32 t)
{
	unsigned int *ptr = NULL;
	unsigned int te_idx = t;
...
static inline int add_score(U32 p, U8 arr[4][16])
{
	U8 i, j, t;
	U8 val;
...
{
	U32 p, i, c, id, t;
	U8 arr[4][16];	/* 4 T-tables, 16 indexes */
	U32 cnt;
	U32 sum;
	U8 ideal[256];
